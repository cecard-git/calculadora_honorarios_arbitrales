...
const iconoA = document.getElementById("iconoA")
const tooltipB = document.getElementById("tooltipB")
const iconoB = document.getElementById("iconoB")


iconoA.addEventListener("mouseenter", () => {
    tooltipA.classList.toggle("escondidoA",false)
})

iconoA.addEventListener("mouseleave", () => {
    tooltipA.classList.toggle("escondidoA",true)
})

iconoB.addEventListener("mouseenter", () => {
    tooltipB.classList.toggle("escondidoB",false)
})

iconoB.addEventListener("mouseleave", () => {
    tooltipB.classList.toggle("escondidoB",true)
})


iconoA.addEventListener("touchstart", () => {
    tooltipA.classList.toggle("escondidoA",false)
})

iconoA.addEventListener("touchend", () => {
    tooltipA.classList.toggle("escondidoA",true)
})

iconoB.addEventListener("touchstart", () => {
    tooltipB.classList.toggle("escondidoB",false)
})

iconoB.addEventListener("touchend", () => {
    tooltipB.classList.toggle("escondidoB",true)
})
...
function calcular() {
    ...
    if(monto>24000000000){
        alert("ingrese un monto menor a 2400000000")
        return;
    }
    if (monto <= 0) {
